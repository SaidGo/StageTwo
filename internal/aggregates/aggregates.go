...
import (
	...
	"example.com/local/Go2part/internal/comments"
	"example.com/local/Go2part/internal/dictionary"
	"example.com/local/Go2part/internal/federation"
	"example.com/local/Go2part/internal/profile"
	"example.com/local/Go2part/internal/reminders"
	"example.com/local/Go2part/internal/s3"
	"example.com/local/Go2part/internal/task"
